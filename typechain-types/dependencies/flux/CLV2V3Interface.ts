...
export interface CLV2V3InterfaceInterface extends utils.Interface {
  functions: {
...
export interface CLV2V3Interface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CLV2V3InterfaceInterface;
